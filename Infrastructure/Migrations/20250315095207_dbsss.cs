...
{
    /// <inheritdoc />
    public partial class dbsss : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequirePhoneConfirmation = table.Column<bool>(type: "bit", nullable: false),
                    RequireAdminApproval = table.Column<bool>(type: "bit", nullable: false),
                    RequireTCApproval = table.Column<bool>(type: "bit", nullable: false),
                    AllowUserRegistration = table.Column<bool>(type: "bit", nullable: false),
                    AllowedLoginMethods = table.Column<byte>(type: "TINYINT", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TC = table.Column<string>(type: "varchar(256)", maxLength: 11, nullable: true),
